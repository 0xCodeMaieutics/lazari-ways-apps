...
export default function VacanciesNewPage() {
  ...
  const form = useForm({
    ...
    defaultValues: {
      title:
        env.NODE_ENV === "development" ? "მუშაობა სათბურში და მინდორში" : "",
      location: env.NODE_ENV === "development" ? "დრეზდენის მახლობლად" : "",
      beginDate: env.NODE_ENV === "development" ? "მაისი" : "",
      duration: env.NODE_ENV === "development" ? "3 თვე" : "",
      salary: env.NODE_ENV === "development" ? "13,90 €/საათში ბრუტო" : "",
      jobDescription: env.NODE_ENV === "development" ? `-სათბურში და მინდორში ჟოლოების, მაყვლის, კენკრისა და სხვა ხილის შეგროვება;
...
-და სხვა დამხმარე სამუშაოები საწარმოში` : "",
      schedule: env.NODE_ENV === "development" ? `-48 საათი/კვირაში და მეტი
-დღეში 8 - 10 საათი
-45 წთ შესვენება
-კვირაში 1 გამოსავალი.` : "",
      accommodation: env.NODE_ENV === "development" ? `მიწოდებულია საცხოვრებელი კონტეინერები ან სახლები – 13 ევრო/დღეში ერთ ადამიანზე, 4 - 8 ადამიანი ერთ ოთახში.
